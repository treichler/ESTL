...
const char * Error_GetMessage(error_code_t error)
{
  ...
  const char * error_messages[] = {
    ...
    [PARAMETER_KEY_COLLISION      - UNKNOWN_ERROR] = "Parameter key collision",
    ...
    [PARAMETER_INDEX_MISMATCH     - UNKNOWN_ERROR] = "Parameter index mismatch",
    [PARAMETER_ENTRIES_MISMATCH   - UNKNOWN_ERROR] = "Parameter entries mismatch",
